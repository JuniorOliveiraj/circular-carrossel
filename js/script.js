( function() {
    ...
    Slider.prototype.rotate = function( multiplier ) {
        ...
        if( this.currentSlide === this.slides.length - 1  && multiplier === -1 ) {
          ...
          this.slidesHolder.style.transform     = 'rotate( 180deg )';
            this.currentSlide = this.currentAngle = 0;
            this.addStyle();

            setTimeout( function(){

                _this.slidesHolder.style.transitionDuration = 8 + 's';
    ...
    Slider.prototype.setNav = function() {
        ...
        _this.btnLeft2.onclick  = function() { _this.rotate(1) };
        _this.btnRight.onclick = function() { _this.rotate(-1) };
        _this.btnRight2.onclick = function() { _this.rotate(-1) };
    ...
    Slider.prototype.disableNav = function() {
        ...
        this.btnLeft2.onclick  = null;
        this.btnRight.onclick = null;

        this.btnRight2.onclick = null;
    ...
    Slider.prototype.addStyle = function() {
        ...
        this.slides[x].style.height = this.slides[x].style.width = this.slidesSize + 110 + 'px';
    ...
    Slider.prototype.resetNavs = function() {
        ...
        this.disableNav();
        setTimeout( function(){ _this.setNav() }, this.startSetup.animationDuration + 110 );
    ...
    ///////////Init sliders/////////// 
    window.circularSlider1 = new Slider( document.querySelector( '.circular-slider-1' ), 100, 15, 600, 10500 );
    window.circularSlider2 = new Slider( document.querySelector( '.circular-slider-2' ), 90, 13, 700, 3000 );
    window.circularSlider3 = new Slider( document.querySelector( '.circular-slider-3' ), 80, 18, 800, 200700 );
    window.circularSlider4 = new Slider( document.querySelector( '.circular-slider-4' ), 70, 20, 900, 300200 );
    autoplay = true
